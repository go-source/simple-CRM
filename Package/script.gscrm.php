...
class Pkg_gscrmInstallerScript
{
	/**
	 ...
	 * @var  string
	 */
	protected $packageName = 'pkg_gscrm';
	...
	private function uninstallFOF($parent)
	{
		...
		if ($dependencyCount)
		{
			$msg = "<p>You have $dependencyCount extension(s) depending on FOF3 and it was not uninstalled. Simple CRM will be removed and FOF3 will remain.</p>";
