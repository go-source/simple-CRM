...
namespace Gs\Gscrm\Site\View\Nav_select;
...
/*
* Select accounts for the campaign
* 
* filter_account (int)
* filter_relation (int)
* filter_male (int)
...
//main selector form
if($item_id == 0){?><div><p><?php echo JText::_('COM_GSCRM_CAMPAIGNS_SELECTOR_EMPTY');}
...
<div>
      ...
      <select class="input-group ml2 high28" id="filter_account" name="filter_account" >
	      <option value="0"><?php echo JText::_('COM_GSCRM_CAMPAIGNS_SELECTOR_NONE') ?></option>
		  <?php
      ...
      <select class="input-group ml2 high28" id="filter_relation" name="filter_relation" >
	      <option value="0"><?php echo JText::_('COM_GSCRM_CAMPAIGNS_SELECTOR_RELATIVES') ?></option>
		  <?php
	...
	<?php echo JText::_('GS_QUERY') ?>
      ...
      <p><?php echo JText::_('COM_GSCRM_CAMPAIGNS_SELECTOR_CHOICES') ?></p>
</div>
...
<?php ;}
		...
		//get cached data
		$storedData = $cache->get($filter_options_name, 'com_gscrm_campaign');
...
if ( $storedData ) {	
?>
<div class="col-lg-12 mt1"><p><?php echo JText::_('COM_GSCRM_CAMPAIGNS_SELECTOR_LIST') ?></p></div>

<div class="col-lg-12">
	<table class="table table-condensed">
		<thead>
			<tr>
				<th><?php echo JText::_('COM_GSCRM_CAMPAIGNS_SELECT') ?></th>
