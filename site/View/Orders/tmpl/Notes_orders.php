...
namespace Gs\Gscrm\Site\View\Notes_orders;
...
$highlite = $model->gscrm_order_id;  //differs from other models
	...
	<div class="col-md-12 pl0 pr0">
		...
		<div class="col-md-4">
			...
			<a role="button" class="btn-xs" title="<?php echo JText::_('GS_SHOW_CLOSED_TIP') ?>"
					<?php if ($item_id) { ?>
						href="index.php?option=com_gscrm&view=Order&id=<?php echo $item_id ?>&nt_show=2&Itemid=<?php echo $menu_item['order'] ?>&<?php echo JSession::getFormToken() ?>=1"
						<?php ; 
						}else{ ?>
						href="index.php?option=com_gscrm&view=Order&account=<?php echo $account ?>&nt_show=2&nt_show=2&Itemid=<?php echo $menu_item['order'] ?>&<?php echo JSession::getFormToken() ?>=1"
						<?php ; 
						} ?> 
					>
			...
			<a role="button" class="btn-xs" title="<?php echo JText::_('GS_HIDE_CLOSED_TIP') ?>"
					<?php if ($item_id) { ?>
						href="index.php?option=com_gscrm&view=Order&id=<?php echo $item_id ?>&nt_show=1&Itemid=<?php echo $menu_item['order'] ?>&<?php echo JSession::getFormToken() ?>=1"
						<?php ; 
						}else{ ?>
						href="index.php?option=com_gscrm&view=Order&account=<?php echo $account ?>&nt_show=1&Itemid=<?php echo $menu_item['order'] ?>&<?php echo JSession::getFormToken() ?>=1"
						<?php ; 
						} ?> 
					>
	...
	<?php		
		...
		{ ?>
			...
			<div class="col-md-10 pl0 pr0">
				...
				<p class="high28 gs_border pt2p <?php if( $highlite == $note->order_id){ echo $highlitetxt ;} ?>">			
			...
			<div class="col-md-2 pl0 pr0">
				...
				<?php
				if($note->enabled == 1){ ?>
				<a class="text-danger" href="index.php?option=com_gscrm&view=Order&id=<?php echo $item_id ?>
											&account=<?php echo $account ?>&flagchg=2&Chgnum=<?php echo $note->gscrm_note_id ?>&nt_show=<?php echo $nt_show ?>
				...
				<?php } else { ?>
				<a class="text-primary" href="index.php?option=com_gscrm&view=Order&id=<?php echo $item_id ?>
											&account=<?php echo $account ?>&flagchg=1&Chgnum=<?php echo $note->gscrm_note_id ?>&nt_show=<?php echo $nt_show ?>
											&Itemid=<?php echo $menu_item['order'] ?>&<?php echo JSession::getFormToken() ?>=1"
